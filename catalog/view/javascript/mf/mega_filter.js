...
MegaFilter.prototype = {
	...
	*/
	...
	initResponsive: function(){
		...
		var alt_attr = $('#language').find('img').attr("alt");
		if(alt_attr == 'ukrainian'){
			var filter_var = 'ФІЛЬТР';
		} else {
			var filter_var = 'ФИЛЬТР';
		}

		var id = 'mfilter-free-container-' + jQuery('[id^="mfilter-free-container"]').length,
			cnt = jQuery('<div class="mfilter-free-container">')
				.prependTo( jQuery('body') ),
			btn = jQuery('<div class="mfilter-free-button"><span>'+ filter_var +'</span>')
				.appendTo( cnt )
				.click(function(){
					if( hidden ) {
						cnt.animate({
