    ...
    <div class="">
        <div><?php echo $content_top; ?>
            ...
            <div class="shop_summary_rating">
				...
				<div class="row">
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12"><div class="shop_summary_general_title"><?php echo $text_summary; ?></div></div>
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12"><div class="shop_summary_general_rating"><?php echo $general['summ']?></div></div>
