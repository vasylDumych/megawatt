...
#supermenu.respmedium ul li div .withchild .mainexpand, #supermenu.respmedium ul li div .withimage .mainexpand, #supermenu-mobile ul li div .withchild .toexpand, #supermenu-mobile ul li div .withchild .toexpandkids { background-color: <?php echo $supermenu_settings['expbm']; ?>; }
<?php } ?>
<?php } ?>
<?php if (isset($supermenu_settings['expbme'])) { ?>
<?php if ($supermenu_settings['expbme']) { ?>
#supermenu.respmedium ul li div .withchild.exped .mainexpand, #supermenu ul li div .withimage .name.exped .mainexpand, #supermenu-mobile ul li div .withchild.exped .toexpand, #supermenu-mobile ul li div .withchild > ul li.exped .toexpandkids { background-color: <?php echo $supermenu_settings['expbme']; ?>; }
<?php } ?>
<?php } ?>
...
#supermenu-mobile ul li div .withchild a.theparent, #supermenu-mobile ul li div .withchild > ul li a, #supermenu-mobile ul li div .withchild > ul li ul li a { color: <?php echo $supermenu_settings['mmol']; ?> !important; }
<?php } ?>
<?php } ?>
<?php if (isset($supermenu_settings['mmod'])) { ?>
<?php if ($supermenu_settings['mmod']) { ?>
#supermenu-mobile ul li div.bigdiv { background-color: <?php echo $supermenu_settings['mmod']; ?> !important; }
<?php } ?>
<?php } ?>
<?php if (isset($supermenu_settings['mmobc'])) { ?>
<?php if ($supermenu_settings['mmobc']) { ?>
#supermenu-mobile ul li div .withchild a.theparent, #supermenu-mobile ul li div .withchild > ul li a { border-color: <?php echo $supermenu_settings['mmobc']; ?> !important; }
<?php } ?>
<?php } ?>
</style>
<?php } ?>