<div id="product-tab-<?php echo $module; ?>" class="product-tab">
  <ul id="tabs-<?php echo $module; ?>" class="tabs container">
  ...
  <?php if($featured_products && $featured_products_status == 1){ ?>
  <div id="tab-featured-<?php echo $module; ?>" class="tab_content container">
  ...
  <?php if($latest_products && $latest_products_status == 1){ ?>
  <div id="tab-latest-<?php echo $module; ?>" class="tab_content container">
    <div class="box-product">
    <div class="owl-carousel product_carousel_tab">
          <?php foreach ($latest_products as $product) { ?>
            <div class="product-item">
              ...
              <?php } ?>
              <div class="cart-bestseller">
                <input type="button" value="<?php echo $button_cart; ?>" onclick="addToCart('<?php echo $product['product_id']; ?>');" class="button btn-bestseller" />
              </div>			  
  ...
  <?php if($bestseller_products && $bestseller_products_status == 1){ ?>
  <div id="tab-bestseller-<?php echo $module; ?>" class="tab_content container">
    <div class="box-product">
    <div class="owl-carousel product_carousel_tab">
