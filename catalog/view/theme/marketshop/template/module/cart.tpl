<div id="cart">
  <div class="heading">
    <a>
    <div class="pull-left flip"></div>
    <img src="/image/data/cart-icon.png" alt="cart icon"/><span class="count-items"><?php echo $text_items; ?></span>
    </a>
  </div>
  <div class="content">
