...
-->
            ...
            <div id="tabs" class="htabs"><a href="#tab-description"><?php echo $tab_description; ?></a>
                ...
                <?php } ?>
                <?php if ($downloads) {?>
                <a href="#tab-downloads"><?php echo $tab_files; ?></a>
                <?php } ?>
                <?php if ($review_status) { ?>
            ...
            <div id="downloads"></div>
                <table><tr><td class="left">
                    ...
                    <a href="<?php echo $download['href']; ?>"><img src="/image/icon_download.png" style="height: 23px; width: 25px; padding-right:5px;" /></a><strong><a style="line-height: normal; vertical-align: 5px;" href="<?php echo $download['href']; ?>"><?php echo $download['name']; ?><?php echo " (". $download['size'] .")";?></a><br>
                    <?php } ?>
                </td></tr></table>
			</div>	
			<?php } ?>
