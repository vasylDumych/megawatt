     ...
     <?php if ($price) { ?>
      ...
      <?php } ?>
        <style>
            ...
            .itemcontainer1, .itemcontainer2, .itemcontainer3 {
                margin: 10px 0;
            }
            ...
            .buyoneclick-cell input{
                margin-top: 20px;
                background: #6a6a6b;
                width: 194px;
            }
            .compare-cell, .wishlist-cell, .note-cell{
                margin: 0 5px;
            }
      ...
      <div class="col-sm-4">
          <div class="parentcontainer">
              ...
              <div class="itemcontainer2">
                  <div class="btn-cell">
                      <input type="button" value="<?php echo $button_cart; ?>" id="button-cart" class="button btn1" />
                  </div>
                  <div>
                      <div class="buyoneclick-cell btn1"><?php echo $buyinoneclick; ?></div>
                  </div>
              </div>

              <div class="itemcontainer3">
                  <div class="compare-cell"><a class="compare" onclick="addToCompare('<?php echo $product_id; ?>');"><img src="/image/data/compare.png" /></a></div>
                  <div class="wishlist-cell"><a class="wishlist" onclick="addToWishList('<?php echo $product_id; ?>');"><img src="/image/data/wishlist.png" /></a></div>
