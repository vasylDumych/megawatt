...
<div id="payment-existing">
  <select name="address_id" class="form-control" style="width: 100%; margin-bottom: 15px;" size="5">
...
<div id="payment-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
  <table class="form">
    ...
    <tr>
      ...
      <td><input type="text" name="company" value="" class="form-control" /></td>
    </tr>
    ...
    <tr>
      ...
      <td><input type="text" name="company_id" value="" class="form-control" /></td>
    </tr>
    <?php } ?>
    ...
    <tr>
      ...
      <td><input type="text" name="tax_id" value="" class="form-control" /></td>
    </tr>
    <?php } ?>
    <tr>
      <td><span class="required">*</span> <?php echo $entry_address_1; ?></td>
      <td><input type="text" name="address_1" value="" class="form-control" /></td>
    </tr>
    <tr>
      <td><?php echo $entry_address_2; ?></td>
      <td><input type="text" name="address_2" value="" class="form-control" /></td>
    </tr>
    <tr>
