...
class ControllerModuleShopRatingHorizontal extends Controller {
    ...
    public function index() {
        ...
        $this->data['show_rating'] = $this->config->get('shop_rating_horizontal_show_rating');
...
/*            if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/shop_rating_horizontal.tpl')) {
                return $this->load->view($this->config->get('config_template') . '/template/module/shop_rating_horizontal.tpl', $this->data);
            } else {
                return $this->load->view('default/template/module/shop_rating_horizontal.tpl', $this->data);
            }*/

            if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/shop_rating_horizontal.tpl')) {
                $this->template = $this->config->get('config_template') . '/template/module/shop_rating_horizontal.tpl';
            } else {
                $this->template = 'default/template/module/shop_rating_horizontal.tpl';
            }
