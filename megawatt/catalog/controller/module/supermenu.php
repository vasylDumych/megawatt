...
/* 		  $brandsinitem = array();
		  ...
		  if ($item['fbrands']) {
		   ...
		   $brandsids  = array();
		    ...
		    foreach ($brandsids as $brandsid) {
			 $brand_info = $this->model_catalog_manufacturer->getSeriesOncesmenu($brandsid);
		     if ($brand_info) {
			   $brandsinitem[] = array(
				'name' => $brand_info['name'],
				'series_id' => $brand_info['series_id'],
				'manufacturer_id' => $brand_info['manufacturer_id'],
				'href' => $this->url->link('product/manufacturer/info', 'manufacturer_id=' . $brand_info['manufacturer_id'] . '&series_id=' . $brand_info['series_id'])
               );
			 }
			}
