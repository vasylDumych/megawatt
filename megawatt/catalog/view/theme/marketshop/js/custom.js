...
var changePriceText = function (qty) {
	var currency = $('.price-old-js').text();
	currency = currency.split(' ');
	currency = currency[1];

	var priceWithoutFormat = $('#price_without_format').text();
	var specialWithoutFormat = $('#special_without_format').text();

	if (priceWithoutFormat) {
		$(".price-old-js").text(parseFloat(qty*priceWithoutFormat).toFixed(2)+' '+currency);
	}
	if (specialWithoutFormat) {
		$(".price-new-js").text(parseFloat(qty*specialWithoutFormat).toFixed(2)+' '+currency);
	}
};
