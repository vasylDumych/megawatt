    ...
    <div class="content">
      <table class="form">
        ...
        <tr>
          ...
          <td><input type="text" name="company_id" value="<?php echo $company_id; ?>" class="form-control" />
        ...
        <tr>
          ...
          <td><input type="text" name="tax_id" value="<?php echo $tax_id; ?>" class="form-control" />
            <?php if ($error_tax_id) { ?>
