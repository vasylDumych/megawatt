...
<div style="width: 680px;"><a href="<?php echo $store_url; ?>" title="<?php echo $store_name; ?>"><img src="<?php echo $logo; ?>" alt="<?php echo $store_name; ?>" style="margin-bottom: 20px; border: none;" /></a>
  ...
  <?php if ($customer_id) { ?>
  <p style="margin-top: 0px; margin-bottom: 20px;"><?php echo $text_greeting_part_1; ?><br />
    <?php echo $text_greeting_part_2;
          echo $order_id;
          echo $text_greeting_part_3; ?>
  ...
  <p style="margin-top: 0px; margin-bottom: 20px;">
    <?php echo nl2br($text_footer); ?>
    <a href="<?php echo $store_url; ?>"><?php echo $store_name; ?></a>
  </p>
  <p style="margin-top: 0px; margin-bottom: 20px;">
    <b><?php echo $text_contact_title; ?></b><br />
    <?php echo $phone_contact_1; ?><br />
    <?php echo $phone_contact_2; ?><br />
    <?php echo $phone_contact_3; ?><br />
