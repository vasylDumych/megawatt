...
<?php $langCode = $lang == 2 ? '/ru' : '' ?>
<div class="row">
	<div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
		<p class="h3"><?php echo $text_about_the_company; ?></p>
		<ul class="footer-info-block">
			<li><a href="<?php echo $langCode; ?>/about/"><?php echo $text_fabout; ?></a></li>
			<li><a href="<?php echo $langCode; ?>/information-shop_rating/"><?php echo $text_reviews; ?></a></li>
			<li><a href="<?php echo $langCode; ?>/information-certificates/"><?php echo $text_certificates; ?></a></li>
		</ul>
	</div>
	<div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
		<p class="h3"><?php echo $text_terms_of_cooperation; ?></p>
		<ul class="footer-info-block">
			<li><a href="<?php echo $langCode; ?>/information-delivery/"><?php echo $text_fdelivery; ?></a></li>
			<li><a href="<?php echo $langCode; ?>/information-payment/"><?php echo $text_fpayment; ?></a></li>
			<li><a href="<?php echo $langCode; ?>/information-dealers/"><?php echo $text_fdealers; ?></a></li>
			<li><a href="<?php echo $langCode; ?>/information-wholesale/"><?php echo $text_wholesale_customers; ?></a></li>
			<li><a href="<?php echo $langCode; ?>/faqs/"><?php echo $text_questions_and_answers; ?></a></li>
		</ul>
	</div>
	<div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
		<p class="h3"><?php echo $text_service; ?></p>
		<ul class="footer-service-block">
		  
		  <li><a href="<?php echo $langCode; ?>/terms-condition"><?php echo $text_fterms; ?></a></li>
		  <li><a href="<?php echo $return; ?>"><?php echo $text_return; ?></a></li>
		  <li><a href="<?php echo $langCode; ?>/information-guarantee/"><?php echo $text_fguarantee; ?></a></li>
		  <li><a href="<?php echo $langCode; ?>/sitemap/"><?php echo $text_fsitemap; ?></a></li>
		</ul>
	</div>
	<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
		<p class="h3"><?php echo $text_fcontacts; ?></p>
	...
	<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
		...
		<div class="timetable">
			<p class="h4"><?php echo $text_ftimetable; ?></p>
			<p><?php echo $text_ftimetable_hours; ?></p>
		</div>
	</div>
</div>
...
.sticky {
  position: fixed;
  top: 121px;  /* если ноль заменить на число (и в скрипте тоже), то блок будет прилипать до того, как верхний край окна браузера дойдёт до верхнего края элемента. Может быть отрицательным числом. Применим, например, при фиксированном сверху меню */
  z-index: 50;
}
.header-row{
	background: #fff;
...
var a = document.querySelector('#menufirst'), b = null;  // селектор блока, который нужно закрепить
...
<script>
(function(){  // анонимная функция (function(){ })(), чтобы переменные "a" и "b" не стали глобальными
var a = document.querySelector('.header-row'), b = null;  // селектор блока, который нужно закрепить
window.addEventListener('scroll', Ascroll, false);
document.body.addEventListener('scroll', Ascroll, false);  // если у html и body высота равна 100%
function Ascroll() {
  if (b == null) {  // добавить потомка-обёртку, чтобы убрать зависимость с соседями
...
<script type="text/javascript">
  (function(d, w, s) {
  var widgetHash = '8567peq6czihybg7pxcy', gcw = d.createElement(s); gcw.type = 'text/javascript'; gcw.async = true;
