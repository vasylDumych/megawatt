...
<?php
		require_once ($_SERVER['DOCUMENT_ROOT'].'/seo_inweb/script.php');
		$seo_tdz = get_seo_tds();
		//print_r($this->SEO);
		//if(trim($this->SEO['title']) != '') $title = $this->SEO['title'];
		//if(trim($this->SEO['description']) != '') $description = $this->SEO['description'];

?>
<title><?php if(isset($seo_tdz['title'])) echo $seo_tdz['title']; else echo $title; ?></title>
<base href="<?php echo $base; ?>" />
<?php if (($description) || isset($seo_tdz['description'])) { ?>
<meta name="description" content="<?php if(isset($seo_tdz['description'])) echo $seo_tdz['description']; else echo $description;?>" />
<?php } ?>
<?php if (($keywords) || isset($seo_tdz['keywords'])) { ?>
<meta name="keywords" content="<?php if(isset($seo_tdz['keywords'])) echo $seo_tdz['keywords']; else echo $keywords;?>" />
<?php } ?>

<?php $base_url = substr($_SERVER['REQUEST_URI'], strpos($_SERVER['REQUEST_URI'], '/ru') === 0 ? 3 : 0); ?>
<link rel="alternate" href="https://s-energia.com.ua<?php echo $base_url; ?>" hreflang="uk" />
<link rel="alternate" href="https://s-energia.com.ua/ru<?php echo $base_url; ?>" hreflang="ru" />

<?php $arr = explode('page=', $_SERVER['REQUEST_URI']);
if ( count($arr) > 1 and end($arr) != 1 ) { ?>
...
dataLayer = [{
    ...
    'transactionShipping': '<?=$order['order_shipping']?>',
    'transactionProducts': [
...
})(window,document,'script','dataLayer','GTM-WCGS5RS');</script>
...
<script type="application/ld+json">
{
  ...
  "@type": "LocalBusiness",
  "image": [
    "https://s-energia.com.ua/image/data/logo/LOGO_KOLOR.jpg"
   ],
   "logo" : "https://s-energia.com.ua/image/data/logo/LOGO_KOLOR.jpg",
  "@id": "http://s-energia.com.ua",
  "name": "Смарт Енергія (Smart Energia)",
  "url" : "https://s-energia.com.ua",
  "address" : {
    "@type" : "PostalAddress",
    "streetAddress" : "вул. Зелена, 251",
  ...
  "geo": {
    "@type": "GeoCoordinates",
    "latitude": 49.8065722,
    "longitude": 24.06417639999995
  },
  "telephone" : "[call-icon] (067) 464-55-77 [call-icon] (095) 464-55-77 [call-icon] (073) 464-55-77",
  "email" : "sales@s-energia.com.ua",
...
#header-service .detail-wishlist-link:before {
    right: 10px;
    top: 12px;
}

#header-service span.count-items{
    padding: 0!important;
    position: absolute;
    background: #fff;
    border-radius: 50%;
...
<script type="text/javascript">
 $('document').ready(function() {
    $('.flyoutmenu ul li a').each(function() {
...
<style>
.flyoutmenu ul li a.activeCSS{
	background: #e8e8e8!important;
    border-right: 2px solid #34aa37!important;
}
.flyoutmenu ul li.menu-title{
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WCGS5RS"
...
<?php if($this->config->get('marketshop_top_bar_contact_status')== 1) {
	...
	$marketshop_top_bar2_contact = $this->config->get('marketshop_top_bar2_contact');
	$marketshop_top_bar3_contact = $this->config->get('marketshop_top_bar3_contact');
...
<div class="col-table-cell col-lg-10 col-md-10 col-sm-12 col-xs-12 inner">
...
<div class="row">
  <div class="col-table-cell col-lg-4 col-md-4 col-sm-12 col-xs-12">
	<div id="search">
    <div class="button-search"></div>
    <input type="text" name="search" id="filter_name" class="form-control" placeholder="<?php echo $text_search; ?>" value="<?php echo $search; ?>" />
	</div>
...
<?php if((isset($marketshop_top_bar_contact[$lang]) && $marketshop_top_bar_contact[$lang] != '')) { ?>

		<li class="mobile<?php echo $this->config->get('marketshop_top_contact_icon'); ?>">
			<img src="/image/data/kyivstar.png" alt="call-icon"/><?php echo $marketshop_top_bar_contact[$lang]; ?>
		</li>

    <?php } ?>
<?php if((isset($marketshop_top_bar2_contact[$lang]) && $marketshop_top_bar2_contact[$lang] != '')) { ?>

		<li class="mobile<?php echo $this->config->get('marketshop_top_contact_icon'); ?>">
			<img src="/image/data/vodafone.png" alt="call-icon"/><?php echo $marketshop_top_bar2_contact[$lang]; ?>
		</li>

    <?php } ?>
<?php if((isset($marketshop_top_bar3_contact[$lang]) && $marketshop_top_bar3_contact[$lang] != '')) { ?>

		<li class="mobile<?php echo $this->config->get('marketshop_top_contact_icon'); ?>">
			<img src="/image/data/lifecell.png" alt="call-icon"/><?php echo $marketshop_top_bar3_contact[$lang]; ?>
		</li>
  ...
  <ul id="header-service">
  <li><a href="http://s-energia.com.ua/<?php echo strpos($_SERVER['REQUEST_URI'], '/ru') === 0 ? 'ru/' : ''; ?>compare-products/"><img src="/image/data/compare-icon.png" alt="compare icon"/></a></li>
	<li>|</li>
	<li><a href="<?php echo $wishlist; ?>" class="detail-wishlist-link"><span class="detail-wishlist-link novisited sprite-side"></span></a></li>
	<li>|</li>
	<li><?php echo $cart; ?></li>
	<li>|</li>
  ...
  <?php /* if (!isset($this->request->get['route']) ||
            ...
            $this->request->get['route'] == 'information/about' ||
            $this->request->get['route'] == 'information/guarantee' ||
            $this->request->get['route'] == 'information/shop_rating' ||
            $this->request->get['route'] == 'information/certificates' ||
            $this->request->get['route'] == 'information/dealers' ||
            $this->request->get['route'] == 'information/wholesale' ||
            $this->request->get['route'] == 'information/faq' ||
            $this->request->get['route'] == 'information/contact' ||
            $this->request->get['route'] == 'information/calc' ||
            $this->request->get['route'] == 'information/delivery' ||
            $this->request->get['route'] == 'information/payment' ||
            $this->request->get['route'] == 'information/information' ||
            $this->request->get['route'] == 'account/return/insert')) { */ ?>
		<div id="menufirst" style="background: #fafafa;"> <div class="container"><?php echo $supermenu; ?> </div></div>
  <?php //} ?>

  <?php if($this->config->get('marketshop_main_menu_style')== 2) { ?><div class="container mainmenu"><?php } ?>
