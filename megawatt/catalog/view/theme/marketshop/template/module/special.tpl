...
<script type="text/javascript">
	$(document).ready(function() {
		...
		itemsCustom : [[320, 1],[600, 2],[768, 3],[992, <?php echo $this->config->get('marketshop_specials_slider_product_per_row'); ?>],[1199, <?php echo $this->config->get('marketshop_specials_slider_product_per_row'); ?>]],											   
		lazyLoad : true,
		navigation : true,
