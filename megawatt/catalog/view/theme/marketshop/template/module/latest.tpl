    ...
    <div class="box-product">
      <div class="owl-carousel latest_carousel">
          ...
          <div class="product-item">
              ...
              <div class="image"><a href="<?php echo $product['href']; ?>"><img class="lazyOwl" data-src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" /></a></div>
              <?php } ?>
...
<script type="text/javascript">
	$(document).ready(function() {
		$(".owl-carousel.latest_carousel").owlCarousel({
		itemsCustom : [[320, 1],[600, 2],[768, 3],[992, <?php echo $this->config->get('marketshop_latest_slider_product_per_row'); ?>],[1199, <?php echo $this->config->get('marketshop_latest_slider_product_per_row'); ?>]],											   
		lazyLoad : true,
		navigation : true,
