...
<script type="text/javascript">
	$(document).ready(function() {
		$(".owl-carousel.bestseller_carousel").owlCarousel({
		itemsCustom : [[320, 1],[600, 2],[768, 3],[992, <?php echo $this->config->get('marketshop_bestsellers_slider_product_per_row'); ?>],[1199, <?php echo $this->config->get('marketshop_bestsellers_slider_product_per_row'); ?>]],											   
		lazyLoad : true,
		navigation : true,
