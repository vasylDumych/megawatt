...
class ControllerInformationFaq extends Controller {
   private $error = array();
     ...
     public function index() {
      $this->language->load('information/faq'); //Optional. This calls for your language file
      ...
      if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/information/faq.tpl')) { //if file exists in your current template folder
         $this->template = $this->config->get('config_template') . '/template/information/faq.tpl'; //get it
      } else {
         $this->template = 'default/template/information/faq.tpl'; //or get the file from the default folder
      }
