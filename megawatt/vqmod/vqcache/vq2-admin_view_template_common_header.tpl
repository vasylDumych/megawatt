...
<li><a href="<?php echo $buyinoneclick; ?>"><?php echo $text_buyinoneclick; ?></a></li>
      ...
      <li id="system"><a class="top"><?php echo $text_system; ?></a>
        <ul>
          ...
          <li><a href="<?php echo $filemanager_full; ?>"><?php echo $text_filemanager_full; ?></a></li>
          <li><a href="<?php echo $backup; ?>"><?php echo $text_backup; ?></a></li>
<li><a href="<?php echo $this->url->link('module/db_cache/clear', 'token=' . $this->session->data['token'].'&redirectRoute='.$_GET['route'], 'SSL'); ?>">Clear DB Cache</a></li>
