...
telephone = '" . $this->db->escape($data['telephone']) . "', ttn = '" . $this->db->escape($data['ttn']) . "',
					 ...
					 fax = '" . $this->db->escape($data['fax']) . "', shipping_firstname = '" . $this->db->escape($data['shipping_firstname']) . "', 
...
'telephone' => $order_query->row['telephone'],'fax'  => $order_query->row['fax'],'ttn'  => $order_query->row['ttn']
					...
					,'email'     => $order_query->row['email'],'payment_firstname'  => $order_query->row['payment_firstname'],'payment_lastname' => $order_query->row['payment_lastname'],'payment_company'  => $order_query->row['payment_company'],'payment_company_id' => $order_query->row['payment_company_id'],
