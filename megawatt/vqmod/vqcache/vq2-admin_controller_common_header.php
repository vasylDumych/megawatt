...
class ControllerCommonHeader extends Controller {
	...
	protected function index() {
		...
		$this->data['text_filemanager_full'] = $this->language->get('text_filemanager_full');
        ...
        $this->data['feed'] = $this->url->link('extention/feed', 'token=' . $this->session->data['token'], 'SSL');
        
        $this->data['text_feed'] = $this->language->get('text_sitemap');
...
$this->data['text_buyinoneclick'] = $this->language->get('text_buyinoneclick');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['filemanager_full'] = $this->url->link('common/filemanager_full', 'token=' . $this->session->data['token'], 'SSL');
...
$this->data['buyinoneclick'] = $this->url->link('catalog/buyinoneclick', 'token=' . $this->session->data['token'], 'SSL');
