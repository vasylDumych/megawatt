<?php echo $header; ?><?php if( ! empty( $mfilter_json ) ) { echo '<div id="mfilter-json" style="display:none">' . base64_encode( $mfilter_json ) . '</div>'; } ?><?php if( ! empty( $mfilter_json ) ) { echo '<div id="mfilter-json" style="display:none">' . base64_encode( $mfilter_json ) . '</div>'; } ?><div class="container">
<div class="row">
    ...
    <div id="content" class="<?php echo $class; ?>">
        ...
        <?php } ?>
        <?php echo $content_top; ?><div id="mfilter-content-container"><div id="mfilter-content-container">
        ...
        <div class="breadcrumb">
            <?php
                ...
                foreach ($breadcrumbs as $breadcrumb) {
                    $index++;
            ?>
            <span itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><?php echo $breadcrumb['separator']; ?><a href="<?php echo $breadcrumb['href']; if (count($breadcrumbs) == $index) echo '#wrapper'; ?>" itemprop="url"><span itemprop="title"><?php echo $breadcrumb['text']; ?></span></a></span>
            <?php } ?>
        </div>

  <h1><?php if(isset($seo_tdz['h1'])) echo $seo_tdz['h1']; else echo $heading_title; ?></h1>
  <?php if ($description) { ?>
...
function display(view) {
  if (view == 'list') {
		...
		$('#content .product-list > div').each(function(index, element) {
			...
			if (image != null) {
				html += '<div class="prod-item"><div class="image">' + image + '</div>';
			}

			html += '  <div class="name">' + $(element).find('.name').html() + '</div>';
			html += '  <div class="stock">' + $(element).find('.stock').html() + '</div>';
			html += '  <div class="description">' + $(element).find('.description').html() + '</div>';
            html += '  <div class="price-table"><div id="catcartbtn" class="cart">' + $(element).find('.cart').html() + '</div>';
			...
			html += '  <div class="compare">' + $(element).find('.compare').html() + '</div><div class="clear"></div></div>';
