...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons olist"><a onclick="$('#form').attr('action', '<?php echo $invoice; ?>'); $('#form').attr('target', '_blank'); $('#form').submit();" class="btn btn-primary"><?php echo $button_invoice; ?></a><a onclick="location = '<?php echo $create; ?>'" class="btn btn-primary"><?php echo $button_create; ?></a><a onclick="$('#form').attr('action', '<?php echo $delete; ?>'); $('#form').attr('target', '_self'); $('#form').submit();" class="btn btn-danger"><?php echo $button_delete; ?></a></div>
    </div>
    <div class="content">
...
function filter() {
	url = 'index.php?route=sale/orderpro&token=<?php echo $token; ?>';
