        ...
        <table class="list">
          ...
          <tbody>
            <tr class="filter">
              <td></td>
              <td></td>
              <td><select class="filtercatadmin" name="filter_category_id">
                  <option value="*"></option>
		  ...
		  <?php }?>
            ...
            <tr>
              ...
              <td class="left"><?php foreach ($product['category'] as $cat) echo $cat . '<br />'; ?></td>
...
<tr>
	      ...
	      <td class="left">{{each(i, cat) category}}${cat}<br/>{{/each}}</td>
...
function filter() {
	url = 'index.php?route=catalog/product_ajax/filter&token=<?php echo $token; ?>';
