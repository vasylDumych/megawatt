            ...
            <tr>
              ...
              <td class="left"><select name="carousel_module[<?php echo $module_row; ?>][position]">
                  ...
                  <?php } ?>
										...
										<?php } ?>
										<?php if ($module['position'] == 'carousel_about') { ?>
										<option value="carousel_about" selected="selected">carousel_about</option>
										<?php } else { ?>
										<option value="carousel_about">carousel_about</option>
										<?php } ?>
...
function addModule() {	
	...
	html += '	  <option value="carousel_about">carousel_about</option>';
	html += '    </select></td>';
