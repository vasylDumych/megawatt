      ...
      <div id="tab_general">
        ...
        <div id="tab_top_menu" class="vtabs-content">
          ...
          <table class="form">
            ...
            <tr>
              <td>Telephone Vodafone:
                <select name="marketshop_top_bar_contact_status2">
                  <option value="0"<?php if($marketshop_top_bar_contact_status2 == '0') echo ' selected="selected"';?>><?php echo $text_disabled; ?></option>
                  <option value="1"<?php if($marketshop_top_bar_contact_status2 == '1') echo ' selected="selected"';?>><?php echo $text_enabled; ?></option>
                </select>
                <a class="marketshop_help" target="_blank" href="../catalog/view/theme/marketshop/image/help/option_10.jpg">?</a></td>
              <td><?php foreach ($languages as $language) { ?>
                <input type="text" name="marketshop_top_bar2_contact[<?php echo $language['language_id']; ?>]" value="<?php echo isset($marketshop_top_bar2_contact[$language['language_id']]) ? $marketshop_top_bar2_contact[$language['language_id']] : ''; ?>" />
                <img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /><br />
                <?php } ?></td>
            </tr>
            <tr>
              <td>Telephone Lifecell:
                <select name="marketshop_top_bar_contact_status3">
                  <option value="0"<?php if($marketshop_top_bar_contact_status3 == '0') echo ' selected="selected"';?>><?php echo $text_disabled; ?></option>
                  <option value="1"<?php if($marketshop_top_bar_contact_status3 == '1') echo ' selected="selected"';?>><?php echo $text_enabled; ?></option>
                </select>
                <a class="marketshop_help" target="_blank" href="../catalog/view/theme/marketshop/image/help/option_10.jpg">?</a></td>
              <td><?php foreach ($languages as $language) { ?>
                <input type="text" name="marketshop_top_bar3_contact[<?php echo $language['language_id']; ?>]" value="<?php echo isset($marketshop_top_bar3_contact[$language['language_id']]) ? $marketshop_top_bar3_contact[$language['language_id']] : ''; ?>" />
                <img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /><br />
                <?php } ?></td>
            </tr>
            <tr>
