  ...
  <div class="box">
    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <?php if ($module['position'] == 'content_top_full') { ?>
        ...
        <?php if ($module['position'] == 'content_top_2_3') { ?>
...
function addModule() {	
	...
	html += '    <td class="left"><select name="slideshow_module[' + module_row + '][position]">';
        ...
        html += '      <option value="content_top_full"><?php echo $text_content_top_full; ?></option>';

      

        html += '      <option value="content_top_2_3"><?php echo $text_content_top_2_3; ?></option>';
