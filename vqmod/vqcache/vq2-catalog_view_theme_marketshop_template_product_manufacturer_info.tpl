...
<div id="content"><?php echo $content_top; ?><div id="mfilter-content-container">
  ...
  <?php if($this->config->get('marketshop_manufacturer_product_per_row')== 'pr3') { ?>
  ...
  <?php $class_grid = 'col-lg-4 col-md-4 col-sm-4 col-xs-12'; ?>
  <?php } ?>
  <?php } elseif ($this->config->get('marketshop_manufacturer_product_per_row')== 'pr4') {?>
  <?php if ($column_left && $column_right) { ?>
  ...
  <?php $class_grid = 'col-lg-3 col-md-3 col-sm-3 col-xs-12'; ?>
  <?php } ?>
  <?php } elseif ($this->config->get('marketshop_manufacturer_product_per_row')== 'pr5') {?>
  <?php if ($column_left && $column_right) { ?>
  ...
  <?php $class_grid = 'col-lg-5ths col-md-5ths col-sm-3 col-xs-12'; ?>
  <?php } ?>
  <?php } elseif ($this->config->get('marketshop_manufacturer_product_per_row')== 'pr6') {?>
  <?php if ($column_left && $column_right) { ?>
...
function display(view) {
	if (view == 'list') {
		...
		$('#content .product-list > div').each(function(index, element) {	
			...
			html += '  <div class="name manufacturer">' + $(element).find('.name').html() + '</div>';
