<?php
$_['lang_title']                    = 'OpenBay Pro для Amazon | Связи товаров';
$_['lang_openbay']                  = 'OpenBay Pro';
$_['lang_overview']                 = 'Обзор Amazon';
$_['lang_btn_return']               = 'Назад';
$_['lang_link_items']               = 'Связь товаров';
$_['lang_item_links']               = 'Связи товара';
$_['lang_desc1']                    = 'Связывание товаров позволит Вам вести учет вашего склада на Amazon.<br /> Для каждого товара который обновляет локальный склад (склад вашего магазина на OpenCart) также обновится список товаров и на Amazon';
$_['lang_desc2']                    = 'Вы можете связать элементы вручную, введя Amazon SKU(артикул) и название товара или загрузить все несвязанные товары, а затем ввести Amazon SKUs(артикулы). (Загрузка товаров из OpenCart для Amazon будет автоматически добавлять связи)';
...
$_['lang_amazon_sku']               = 'Amazon SKU(артикул) товара';
