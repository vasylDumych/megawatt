        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validate())) {
            ...
            if (isset($this->request->post['tags'])) {
			 ...
			 if (isset($this->request->post['states'])) {
                $this->model_module_deadcow_seo->generateStates($this->request->post['source_language_code']);
            }
			if (isset($this->request->post['image'])) {
			$all=false; $del=false; $copy=false;
				if (isset($this->request->post['Сimage'])) $all=true; // если запущенна массовое исправление
				if (isset($this->request->post['СimageDel'])) $del=true;
				if (isset($this->request->post['СimageCopy'])) $copy=true;
				
                $this->model_module_deadcow_seo->generateImage($all,$del,$copy,$this->request->post['source_language_code']);
            }
			if (isset($this->request->post['rodn'])) {
                $this->model_module_deadcow_seo->generateBasic($this->request->post['textSql'],$this->request->post['source_language_code']);
            }
