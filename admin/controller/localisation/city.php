...
class ControllerLocalisationCity extends Controller {
	...
	protected function getList() {
		...
		$this->data['city_update'] = $this->url->link('localisation/city_update', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		$this->data['button_city_update'] = $this->language->get('button_city_update');
