<?php echo $header; ?>
            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" name="newsform">
                <table class="form">
                    <?php foreach ($languages as $language) { ?>
                        <tr>
                            ...
                            <td>
                                <input type="text" name="news_customtitle<?php echo $language['language_id']; ?>"
                                       id="news_customtitle<?php echo $language['language_id']; ?>" size="30"
                                       value="<?php echo ${'news_customtitle' . $language['language_id']}; ?>"/>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="news_thumb_width" value="<?php echo $news_thumb_width; ?>"
                                   size="3"/> x
                            <input type="text" name="news_thumb_height" value="<?php echo $news_thumb_height; ?>"
                                   size="3"/> px
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="news_popup_width" value="<?php echo $news_popup_width; ?>"
                                   size="3"/> x
                            <input type="text" name="news_popup_height" value="<?php echo $news_popup_height; ?>"
                                   size="3"/> px
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="news_headline_chars" value="<?php echo $news_headline_chars; ?>"
                                   size="3"/> chars
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="news_pagination_val" value="<?php echo $news_pagination_val; ?>"
                                   size="3"/>
                        </td>
                    </tr>
                    <tr>
                        <td><a onclick="window.open('http://www.villagedefrance.net');" title="villagedefrance"><img
                                    src="view/image/villagedefrance.png" alt=""/></a></td>
                ...
                <table id="module" class="list">
                    ...
                    <?php foreach ($modules as $module) { ?>
                        ...
                        <tr>
                            <td class="left"><input type="text" name="news_module[<?php echo $module_row; ?>][limit]"
                            ...
                            <td class="left">
                                <input type="text" name="news_module[<?php echo $module_row; ?>][numchars]"
                            ...
                            <td class="left">
                                <select name="news_module[<?php echo $module_row; ?>][position]">
                                    ...
                                    <?php } ?>
										...
										<option value="footer_new" selected="selected">footer_new</option>
										<?php } else { ?>
										<option value="footer_new">footer_new</option>
										<?php } ?>
                                </select>
                            </td>
                            <td class="left">
                            ...
                            <td class="center"><input type="text"
                                                      name="news_module[<?php echo $module_row; ?>][sort_order]"
    ...
    <br /><div style="text-align: center"><?php echo $easy_news_version; ?></div>
    </div>
	...
	html += '	  <option value="footer_new">footer_new</option>';
            html += '    </select></td>';
    ...
    <script type="text/javascript">
        function buttonSave() {
            document.newsform.buttonForm.value = 'save';
            $('#form').submit();
        }
        function buttonApply() {
            document.newsform.buttonForm.value = 'apply';
            $('#form').submit();
        }
    </script>
