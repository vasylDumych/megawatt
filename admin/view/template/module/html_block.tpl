							...
							<tr>
								...
								<td class="left">
									<select name="html_block_module[<?php echo $module_row; ?>][position]">
										...
										<?php } ?>
										<?php if ($module['position'] == 'additional_info') { ?>
										<option value="additional_info" selected="selected">additional_info</option>
										<?php } else { ?>
										<option value="additional_info">additional_info</option>
										<?php } ?>
										<?php if ($module['position'] == 'header_baner') { ?>
										<option value="header_baner" selected="selected">header_baner</option>
										<?php } else { ?>
										<option value="header_baner">header_baner</option>
										<?php } ?>
...
function addModule() {	
	...
	html += '	  <option value="additional_info">additional_info</option>';
	html += '	  <option value="header_baner">header_baner</option>';
